				...
				<?php
					...
					while($row = mysqli_fetch_assoc($query_run)){
						...
						<tr>
							...
							<td>
								<button class="btn" name=""><a href="editbook.php?bn=<?php echo $row['book_no'];?>">Edit</a></button>
								<button class="btn" name=""><a href="deletebook.php?bn=<?php echo $row['book_no'];?>">Delete</a></button>
							</td>
						</tr>
						<?php
					}
