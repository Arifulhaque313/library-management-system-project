 ...
 <div class="row container-fluid userdash">
    ...
    <div class="col-md-3">
        <div class="card" style="width: 18rem;border-radius:20px">
            ...
            <div class="card-body" >
               <h5 class="card-title card-header">Registed users</h5>
               <p class="card-text card-body">No of users :--</p>
                 <a href="#" class="btn btn-danger">view registered users </a>
            </div>
          </div>
        ...
        <div class="card" style="width: 18rem;border-radius:20px">
            ...
            <div class="card-body" >
               ...
               <p class="card-text card-body">Total catagories :--</p>
    ...
    <div class="col-md-3">
        <div class="card" style="width: 18rem;border-radius:20px">
            ...
            <div class="card-body" >
               <h5 class="card-title card-header">Books issued</h5>
               <p class="card-text card-body">No of issued books:--</p>
